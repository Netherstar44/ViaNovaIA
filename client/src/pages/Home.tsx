        ...
        {viewMode === 'landing' ? (
          ...
          >
            ...
            <HeroSection>
              ...
              >
                <div className="bg-white dark:bg-[#222222] rounded-[9999px] p-2 shadow-[0_8px_28px_rgba(0,0,0,0.28)] flex flex-col md:flex-row items-center max-w-[880px] mx-auto">

                  <div className="flex-1 min-w-[200px] w-full bg-transparent rounded-full flex items-center px-6 h-14 hover:bg-[#f7f7f7] dark:hover:bg-[#111111] transition-colors border border-transparent focus-within:bg-[#ffffff] dark:focus-within:bg-[#222222] group">
                    <div className="flex flex-col justify-center w-full">
                      <label className="text-[12px] font-bold text-[#222222] dark:text-white px-4">{t('home.search_placeholder') || 'Where'}</label>
                      <input
                        type="text"
                        placeholder="Search destinations"
                        value={searchQuery}
                        onChange={(e) => setSearchQuery(e.target.value)}
                        className="w-full bg-transparent border-none outline-none focus:ring-0 px-4 text-[14px] text-[#6a6a6a] placeholder:text-[#6a6a6a]"
                      />
                    </div>
                  </div>

                  <div className="w-[1px] h-8 bg-[#ebebeb] dark:bg-[#6a6a6a] hidden md:block"></div>

                  <div className="flex flex-wrap md:flex-nowrap w-full md:w-auto">
                    <div className="relative flex-1 md:flex-none hover:bg-[#f7f7f7] dark:hover:bg-[#111111] rounded-full flex items-center">
                      <div className="flex flex-col justify-center w-full px-2">
                        <label className="text-[12px] font-bold text-[#222222] dark:text-white px-4 pointer-events-none absolute top-1">{t('home.distance') || 'Distance'}</label>
                        <select
                          value={distanceFilter}
                          onChange={(e) => setDistanceFilter(e.target.value)}
                          className="w-full h-14 pl-4 pt-4 pr-8 rounded-full border-none bg-transparent text-[14px] text-[#6a6a6a] appearance-none outline-none cursor-pointer"
                        >
                    ...
                    <div className="w-[1px] h-8 bg-[#ebebeb] dark:bg-[#6a6a6a] hidden md:block self-center"></div>

                    <div className="relative flex-1 md:flex-none hover:bg-[#f7f7f7] dark:hover:bg-[#111111] rounded-full flex items-center">
                      <div className="flex flex-col justify-center w-full px-2">
                        <label className="text-[12px] font-bold text-[#222222] dark:text-white px-4 pointer-events-none absolute top-1">{t('home.price') || 'Price'}</label>
                        <select
                          value={priceFilter}
                    ...
                    <Button className="w-full md:w-12 md:h-12 h-14 md:rounded-full rounded-xl bg-[#ffbf00] text-black flex items-center justify-center hover:bg-[#e6ac00] transition-colors shadow-none ml-2">
